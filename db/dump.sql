...
CREATE TABLE public.evento (
    ...
    eta_minima smallint NOT NULL,
    prezzo smallint,
    descrizione text,
    id_utente_organizzatore integer NOT NULL
);
...
--
-- Name: evento_id_utente_organizzatore_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.evento_id_utente_organizzatore_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.evento_id_utente_organizzatore_seq OWNER TO postgres;

--
-- Name: evento_id_utente_organizzatore_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.evento_id_utente_organizzatore_seq OWNED BY public.evento.id_utente_organizzatore;
...
--
-- Name: evento id_utente_organizzatore; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.evento ALTER COLUMN id_utente_organizzatore SET DEFAULT nextval('public.evento_id_utente_organizzatore_seq'::regclass);
...
COPY public.evento (id, nome, priorita, citta, via, numero_civico, data, numero_partecipanti, max_num_partecipanti, eta_minima, prezzo, descrizione, id_utente_organizzatore) FROM stdin;
\.
...
--
-- Name: evento_id_utente_organizzatore_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.evento_id_utente_organizzatore_seq', 1, false);
...
--
-- Name: evento evento_id_utente_organizzatore_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.evento
    ADD CONSTRAINT evento_id_utente_organizzatore_fkey FOREIGN KEY (id_utente_organizzatore) REFERENCES public.utente(id);
