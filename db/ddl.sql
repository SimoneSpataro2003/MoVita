...
COPY public.amicizia (id_utente, id_evento) FROM stdin;
\.
...
ALTER TABLE ONLY public.amicizia
    ADD CONSTRAINT amicizia_pkey PRIMARY KEY (id_utente, id_evento);
...
--
-- Name: amicizia fk_id_evento; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: amicizia fk_id_utente; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
